...
inpainting_mask_meta="/home/ubuntu/jin/data/video_painter/mt_test_removal.csv"
...
output_base_path="/home/ubuntu/jin/results/video_painter/mt/removal_inp_fps${down_sample_fps}_dilate_${dilate_size}_${data_kind}"
